...
public class MetricsLeaderboardJob {
    ...
    private String redisTenantIdentifier;
    @PostConstruct
    public void init() {
        /**
        ...
        redisTenantIdentifier = System.getenv().get("REDIS_TENANT_IDENTIFIER");
    ...
    public void timeout(Timer timer) {
        ...
        Set<Tuple> zrangeByScoreWithScores = jedis.zrevrangeByScoreWithScores(redisTenantIdentifier+"-"+redisMetricsLeaderBoardSet, Integer.MAX_VALUE, 1);
